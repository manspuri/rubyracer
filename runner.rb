...
players = ['         Clayton', '      Speedracer', '       GaleForce', 'DaleEarnhardtJr', '    RichardSimmons', '           Mansi', '       Buttercup', '           John', '      DonScraper', '            Frog', '          Potato', '       dragMagic', '         Scraper', '      DonaldDuck', '          Mansi2', '         LoRyder', '        Megatron', '  BlackLightning', '   DanisaurusRex', '    SecondPlace', ' CandidKilsborne', '            Fifi', '         Artemis', '          Hermes', ' JenniferLawrence', '     flashBandit', '          Peggy', '          theKid', '        Dremen42', '          Maaansh', '            Bolt', '         Shomari', '            Jimbo'].shuffle
